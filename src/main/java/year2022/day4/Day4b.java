...
//	private static final String FILENAME = "src/main/resources/2022/day4InputSample.txt";
	...
	public static void main(String[] args) throws IOException {
		...
		Set<AssignmentGroup> assignmentGroupsThatOverlapAnyOther =  assignmentGroups.stream()
				.filter(ag -> ! ag.getAssignmentsThatOverlapAnyOther().isEmpty())
				.collect(Collectors.toSet());
		
		System.out.println(assignmentGroupsThatOverlapAnyOther.size());
